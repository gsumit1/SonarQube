...
public class TheInternetLoginPage extends Base {
    ...
    public void openLoginScreen() throws InterruptedException {
        visit(LOGIN_URL);
        getDriver().get("http://the-internet.herokuapp.com/login"); // Noncompliant {{Avoid using hard coded url}}
    ...
    public String getConfirmationText() {
        driver.get("http://the-internet.herokuapp.com/login"); // Noncompliant {{Avoid using hard coded url}}
