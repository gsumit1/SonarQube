...
public class CommonData {
    ...
    public static final String HARD_CODED_WAITABIT_CHECK_KEY="hard-coded-waitabit-check";
    public static final String AVOID_NULL_RETURN="avoid-null-return-check";
    public static final String AVOID_HARD_CODING_TXTBOX="avoid-hard-coding-for-textbox-check";
    public static final String AVOID_HARD_CODING_DROPDOWN="avoid-hard-coding-for-dropdown-check";
    public static final String AVOID_XPATH_CREATION_IN_STEPS="avoid-xpath-creation-in-steps-check";
    public static final String AVOID_SERENITY_SESSION_VARIABLE_IN_TOOL="avoid-serenity-session-variable-in-tool-check";
    public static final String HARD_CODED_URL_CHECK_KEY="avoid-hard-coded-url-check";
